...
def add_over_under_features(df: pd.DataFrame) -> pd.DataFrame:
...
def main() -> None:
    ...
    evaluate_model("Logistic Regression Over/Under 2.5", logistic_model, X_val, y_val, X_test, y_test)
    evaluate_model("Random Forest Over/Under 2.5", rf_model, X_val, y_val, X_test, y_test)
